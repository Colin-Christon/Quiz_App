...
public class Data_structure {
    ...
    private void setOne(){
        ...
        list.add(new QuestionModel("Which data structure follows the Last-In-First-Out (LIFO) principle?", "Stack", "Queue", "Linked List", "Tree", "Stack"));
        list.add(new QuestionModel("What is the time complexity of searching an element in a balanced binary search tree?", "O(log n)", "O(n)", "O(1)", "O(n log n)", "O(log n)"));
        list.add(new QuestionModel("Which data structure is best suited for implementing a dictionary?", "Hash table", "Binary search tree", "Heap", "Array", "Hash table"));
        ...
        list.add(new QuestionModel("What data structure is used to store key-value pairs with constant-time lookup?", "Hash table", "Binary search tree", "Heap", "Array", "Hash table"));
        ...
        list.add(new QuestionModel("What is the time complexity of deleting an element from a binary heap?", "O(log n)", "O(n)", "O(1)", "O(n log n)", "O(log n)"));

    }

    private void setTwo(){
        list.add(new QuestionModel("What is the difference between a stack and a queue?", "Order of removal", "Order of insertion", "Underlying data structure", "Size limitation", "Order of removal"));
