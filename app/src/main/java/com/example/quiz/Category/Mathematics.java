...
public class Mathematics {
    ...
    private void setOne() {
        list.add(new QuestionModel(" Solve the equation: 2x + 5 = 15", "x = 5", "x = 6", "x = 7", "x = 8", "x = 5"));
        ...
        list.add(new QuestionModel(" Find the square root of 144.", "12", "10", "14", "16", "12"));
        ...
        list.add(new QuestionModel(" Evaluate: 5! (factorial)", "120", "100", "140", "110", "120"));
        list.add(new QuestionModel(" Find the perimeter of a rectangle with length 8 cm and width 5 cm.", "26 cm", "30 cm", "32 cm", "24 cm", "26 cm"));
        list.add(new QuestionModel(" Simplify the expression: 2x² + 3x - 5x + 4", "2x² - 2x + 4", "2x² + 2x - 4", "2x² - 8x + 4", "2x² + 8x + 4", "2x² - 2x + 4"));
        list.add(new QuestionModel(" What is the value of sin(60°)?", "√3/2", "1/2", "1", "√2/2", "√3/2"));

    }

    private void setTwo(){
        list.add(new QuestionModel(" Solve the equation: 3x - 7 = 14", "x = 7", "x = 8", "x = 9", "x = 10", "x = 7"));
        list.add(new QuestionModel(" What is the value of e (Euler's number) to three decimal places?", "2.718", "2.716", "2.720", "2.714", "2.718"));
        ...
        list.add(new QuestionModel(" Solve the equation: 4(x - 5) = 36", "x = 11", "x = 12", "x = 13", "x = 14", "x = 11"));
        list.add(new QuestionModel(" What is the value of log₂32?", "5", "4", "3", "2", "5"));
        list.add(new QuestionModel(" Evaluate: 6! (factorial)", "720", "640", "840", "760", "720"));
        ...
        list.add(new QuestionModel(" What is the value of cos(45°)?", "√2/2", "1/2", "1", "√3/2", "√2/2"));
    ...
    private void setThree() {
        ...
        list.add(new QuestionModel(" Simplify the expression: 2(3x - 4) + 5x", "11x - 8", "11x + 8", "11x - 10", "11x + 10", "11x - 8"));
        list.add(new QuestionModel(" Find the area of a circle with radius 5 cm (use π = 3.14).", "78.5 cm²", "75.4 cm²", "80.6 cm²", "82.5 cm²", "78.5 cm²"));
        list.add(new QuestionModel(" Solve the equation: 2(x + 6) = 32", "x = 10", "x = 11", "x = 12", "x = 13", "x = 10"));
        ...
        list.add(new QuestionModel(" What is the value of tan(30°)?", "1/√3", "√3", "1", "√2/2", "1/√3"));
    ...
    private void setEight() {
        list.add(new QuestionModel(" Solve the equation: 2x + 5 = 17", "x = 6", "x = 7", "x = 8", "x = 9", "x = 6"));
        ...
        list.add(new QuestionModel(" Find the area of a triangle with base 8 cm and height 6 cm.", "24 cm²", "20 cm²", "18 cm²", "16 cm²", "24 cm²"));
        ...
        list.add(new QuestionModel(" Evaluate: 12!", "479,001,600", "473,001,600", "482,001,600", "478,001,600", "479,001,600"));
        ...
        list.add(new QuestionModel(" What is the value of cosec(45°)?", "√2", "1", "1/√3", "√3", "√2"));
    ...
    private void setNine() {
        ...
        list.add(new QuestionModel(" Simplify the expression: 2(5x - 3) + 4x", "14x - 6", "14x + 6", "14x - 4", "14x + 4", "14x - 6"));
        list.add(new QuestionModel(" Find the area of a square with side length 9 cm.", "81 cm²", "72 cm²", "90 cm²", "99 cm²", "81 cm²"));
        list.add(new QuestionModel(" Solve the equation: 2(x + 3) = 28", "x = 11", "x = 12", "x = 13", "x = 14", "x = 11"));
        list.add(new QuestionModel(" What is the value of log₅25?", "2", "3", "4", "5", "2"));
        list.add(new QuestionModel(" Evaluate: 13!", "6,227,020,800", "6,123,020,800", "6,327,020,800", "6,213,020,800", "6,227,020,800"));
        list.add(new QuestionModel(" Find the circumference of a circle with diameter 12 cm (use π = 3.14).", "37.68 cm", "38.28 cm", "37.14 cm", "36.84 cm", "37.68 cm"));
        list.add(new QuestionModel(" Simplify the expression: 5x² - 3x + 2x - 6", "5x² - x - 6", "5x² - x + 6", "5x² + x - 6", "5x² + x + 6", "5x² - x - 6"));
        list.add(new QuestionModel(" What is the value of sec(30°)?", "2", "√2", "1/√3", "√3", "2"));

    }

    private void setTen() {
        list.add(new QuestionModel(" Solve the equation: 4x + 8 = 32", "x = 6", "x = 7", "x = 8", "x = 9", "x = 6"));
        ...
        list.add(new QuestionModel(" Evaluate: 14!", "87,178,291,200", "86,778,291,200", "87,378,291,200", "87,078,291,200", "87,178,291,200"));
